/*
  ...
  This migration sets up the core database schema for the restaurant management system.
  ...
  2. Features:
    ...
    - Status tracking for orders and tables
    - Comprehensive indexing for performance
*/

-- Profiles for user roles and details
CREATE TABLE profiles (
  id uuid PRIMARY KEY REFERENCES auth.users(id) ON DELETE CASCADE,
  email text NOT NULL,
  full_name text,
  role text NOT NULL CHECK (role IN ('admin', 'waiter', 'manager')),
