/*
  ...
  1. Changes
    - Ensure menu_item_id column exists and has correct foreign key
    - Add trigger to handle order status updates
...
-- Ensure menu_item_id column exists
DO $$ 
BEGIN
...
-- Create or replace trigger for order status updates
