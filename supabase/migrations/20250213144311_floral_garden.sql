...
INSERT INTO menu_items (
  ...
  (
    ...
    13.00,
    '15 minutes',
    ARRAY['glutine', 'uova', 'lattosio']::text[],
    ARRAY['spaghetti', 'uova', 'guanciale', 'pecorino', 'pepe nero']::text[],
    true,
    false,
    false,
    false,
  ...
  (
    ...
    '20 minutes',
    ARRAY['lattosio']::text[],
    ARRAY['riso', 'funghi porcini', 'parmigiano', 'burro', 'cipolla']::text[],
    true,
    true,
    false,
    true,
  ...
  (
    ...
    '15 minutes',
    ARRAY['lattosio']::text[],
    ARRAY['manzo', 'rucola', 'parmigiano', 'olio']::text[],
    true,
    false,
    false,
    true,
  ...
  (
    ...
    '25 minutes',
    ARRAY[]::text[],
    ARRAY['patate', 'rosmarino', 'olio', 'sale']::text[],
    true,
    true,
    true,
    true,
  ...
  (
    ...
    '0 minutes',
    ARRAY['glutine', 'uova', 'lattosio']::text[],
    ARRAY['savoiardi', 'caffè', 'mascarpone', 'uova', 'cacao']::text[],
    true,
    true,
    false,
    false,
