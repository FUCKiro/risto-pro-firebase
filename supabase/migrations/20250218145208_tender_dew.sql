...
BEGIN
  -- Menu categories
  SELECT table_exists('menu_categories') INTO v_table_exists;
  ...
  -- Menu items
  SELECT table_exists('menu_items') INTO v_table_exists;
  IF NOT v_table_exists THEN
  ...
  -- Orders
  SELECT table_exists('orders') INTO v_table_exists;
  IF NOT v_table_exists THEN
    CREATE TABLE orders (
      id serial PRIMARY KEY,
  ...
  -- Order items
  SELECT table_exists('order_items') INTO v_table_exists;
  IF NOT v_table_exists THEN
  ...
  -- Reservations
  SELECT table_exists('reservations') INTO v_table_exists;
  IF NOT v_table_exists THEN
...
BEGIN
  ...
  IF v_table_exists THEN
    SELECT EXISTS (
      ...
      WHERE tgname = 'update_menu_categories_updated_at'
...
BEGIN
  ...
  IF v_table_exists THEN
    SELECT EXISTS (
      SELECT 1 FROM pg_trigger 
      WHERE tgname = 'update_order_status_on_items'
    ) INTO v_trigger_exists;
...
BEGIN
  ...
  IF v_table_exists THEN
    SELECT EXISTS (
      SELECT 1 FROM pg_trigger 
      WHERE tgname = 'update_order_total_on_items'
    ) INTO v_trigger_exists;
...
BEGIN
  ...
  IF v_table_exists THEN
    SELECT EXISTS (
      SELECT 1 FROM pg_trigger 
      WHERE tgname = 'initialize_order_total_on_insert'
    ) INTO v_trigger_exists;
...
BEGIN
  ...
  IF v_table_exists THEN
    SELECT EXISTS (
      ...
      WHERE indexname = 'menu_items_category_id_idx'
    ) INTO v_index_exists;
    ...
    SELECT EXISTS (
      SELECT 1 FROM pg_indexes 
      WHERE indexname = 'menu_items_is_available_idx'
    ) INTO v_index_exists;
    IF NOT v_index_exists THEN
  ...
  IF v_table_exists THEN
    SELECT EXISTS (
      SELECT 1 FROM pg_indexes 
      WHERE indexname = 'menu_categories_order_idx'
    ) INTO v_index_exists;
    IF NOT v_index_exists THEN
    ...
    SELECT EXISTS (
      SELECT 1 FROM pg_indexes 
      WHERE indexname = 'menu_categories_is_active_idx'
    ) INTO v_index_exists;
    IF NOT v_index_exists THEN
  ...
  IF v_table_exists THEN
    SELECT EXISTS (
      SELECT 1 FROM pg_indexes 
      WHERE indexname = 'order_items_order_id_idx'
    ) INTO v_index_exists;
    IF NOT v_index_exists THEN
    ...
    SELECT EXISTS (
      SELECT 1 FROM pg_indexes 
      WHERE indexname = 'order_items_menu_item_id_idx'
    ) INTO v_index_exists;
    IF NOT v_index_exists THEN
    ...
    SELECT EXISTS (
      SELECT 1 FROM pg_indexes 
      WHERE indexname = 'order_items_status_idx'
    ) INTO v_index_exists;
    IF NOT v_index_exists THEN
  ...
  IF v_table_exists THEN
    SELECT EXISTS (
      SELECT 1 FROM pg_indexes 
      WHERE indexname = 'orders_table_id_idx'
    ) INTO v_index_exists;
    IF NOT v_index_exists THEN
    ...
    SELECT EXISTS (
      SELECT 1 FROM pg_indexes 
      WHERE indexname = 'orders_waiter_id_idx'
    ) INTO v_index_exists;
    IF NOT v_index_exists THEN
    ...
    SELECT EXISTS (
      SELECT 1 FROM pg_indexes 
      WHERE indexname = 'orders_status_idx'
    ) INTO v_index_exists;
    IF NOT v_index_exists THEN
    ...
    SELECT EXISTS (
      SELECT 1 FROM pg_indexes 
      WHERE indexname = 'orders_merged_order_id_idx'
    ) INTO v_index_exists;
    IF NOT v_index_exists THEN
  ...
  IF v_table_exists THEN
    SELECT EXISTS (
      SELECT 1 FROM pg_indexes 
      WHERE indexname = 'reservations_table_id_idx'
    ) INTO v_index_exists;
    IF NOT v_index_exists THEN
    ...
    SELECT EXISTS (
      SELECT 1 FROM pg_indexes 
      WHERE indexname = 'reservations_date_idx'
    ) INTO v_index_exists;
    IF NOT v_index_exists THEN
    ...
    SELECT EXISTS (
      SELECT 1 FROM pg_indexes 
      WHERE indexname = 'reservations_status_idx'
    ) INTO v_index_exists;
    IF NOT v_index_exists THEN
